...
const Cta = () => {
  return (
    <>
      <div className="lg:relative lg:block hidden mr-20 h-[190px] bg-[#a1a5ff] py-16 z-50">
      ...
      <div className="lg:hidden flex flex-col bg-[#a1a5ff] text-[22px] z-50 py-8 text-center items-center px-9">
        <div className=" flex flex-col justify-between 2xl:pl-40 my-4">
          <div className="text-white">
            ...
            <div className="-mr-6">
                <button className="text-[21px] my-4 px-8 py-3 bg-white rounded-md">Get Started Today</button>
