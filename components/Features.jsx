    ...
    <div className=' pt-[75px] w-full bg-[#fbfbff]'>
        ...
        <div className='py-20 px-2 2xl:px-40 grid grid-cols-3'>
            <div className='grid grid-cols-[1fr,4fr]'>
                <div>
                    <Image src="/../public/assets/icon-person.png"  width={69} height={69} alt="/" />
                </div>
                <div className='px-7'>
            ...
            <div className='grid grid-cols-[1fr,4fr]'>
                <div>
                    <Image  className='' src="/../public/assets/icon-money.png" width={69} height={69} alt="/" />
                </div>
                <div className='px-5'>
            ...
            <div className='grid grid-cols-[1fr,4fr]'>
                <div>
                    <Image  className='' src="/../public/assets/icon-growth.png" width={69} height={69} alt="/" />
                </div>
                <div className='px-5'>
