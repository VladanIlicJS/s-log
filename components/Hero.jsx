        ...
        <div className=" pt-[60px] 2xl:px-40 h-full">
          <div className="grid lg:grid-cols-2 grid-cols-1 lg:text-left text-center h-full 2xl:px-0 lg:px-9 ">
            <div className="flex flex-col h-full justify-center lg:items-start items-center lg:px-0 px-9">
              <h1 className="lg:text-[54px] text-[30px] text-[#02073E] leading-[40px] lg:leading-[54px]">
                Customizable Route
              </h1>
              <h1 className="lg:text-[54px] text-[30px] font-[500]  text-[#a1a5ff]">
                Planning Software
              </h1>
              <p className="mt-2 lg:text-[16px] text-[12px] leading-5 text-[#3c3c46] font-[400] ">
                Optimize performance, cut down costs, and achieve your business goals with SLog, the
                first fully customizable route planning software.
              </p>
              <Link href='/#bottom'>
                <button className=" lg:text-[18px] text-[12px] bg-[#a1a5ff] text-white mt-10 pt-[12px] pb-[12px] rounded-md  font-[400] hover:bg-[#8387f9] transition duration-300 ease-out lg:w-[45%] px-4">
